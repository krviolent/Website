...
<script RunAt="server">
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        // в вашем приложении.
        // Дополнительные сведения о регистрации модели EDM в платформе динамических данных см. на странице https://go.microsoft.com/fwlink/?LinkId=257395.     
        ...
        // Следующий оператор поддерживает режим separate-page, в котором задачи List, Detail, Insert 
